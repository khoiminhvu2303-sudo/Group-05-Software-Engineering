...
public class AuditLogInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response,
        ...
        Audittable auditable = handlerMethod.getMethodAnnotation(Audittable.class);
    ...
    private String buildDescription(HttpServletRequest request, Audittable auditable,
